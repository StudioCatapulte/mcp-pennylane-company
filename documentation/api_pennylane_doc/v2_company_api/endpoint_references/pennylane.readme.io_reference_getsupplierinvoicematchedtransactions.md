---
url: "https://pennylane.readme.io/reference/getsupplierinvoicematchedtransactions"
title: "List matched transactions for a supplier invoice"
---
...
# `` 200      Returns the list of matched transactions for a supplier invoice. If the invoice is archived, an empty list will be returned.
...
2     --url 'https://app.pennylane.com/api/external/v2/supplier_invoices/supplier_invoice_id/matched_transactions?sort=-id' \
